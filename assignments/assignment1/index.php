...
$output = "";
    foreach ($dataFile as $item => $value){
        if($item == "Web Design Development") {
            ...
            <div class='col-md-9'>
            <div class='progress'>
              <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow='$value' aria-valuemin='0' aria-valuemax='100' style='min-width: 0em; width: $value%;'>
                $value
              </div>
            </div></div>";
        }
        ...
        if($item == "Red"){
            ...
            <div class='col-md-9'>
            <div class='progress'>
              <div class='progress-bar progress-bar-warning' role='progressbar' aria-valuenow='$value' aria-valuemin='0' aria-valuemax='100' style='min-width: 0em; width: $value%;'>
                $value
              </div>
            </div></div>";
        }
        ...
        if ($item == "Dominos"){
            ...
            <div class='col-md-9'>
            <div class='progress'>
              <div class='progress-bar progress-bar-info' role='progressbar' aria-valuenow='$value' aria-valuemin='0' aria-valuemax='100' style='min-width: 0em; width: $value%;'>
                $value
              </div>
            </div></div>";
        }
        ...
        if ($item == "Camping"){
            ...
            <div class='col-md-9'>
            <div class='progress'>
              <div class='progress-bar progress-bar-danger' role='progressbar' aria-valuenow='$value' aria-valuemin='0' aria-valuemax='100' style='min-width: 0em; width: $value%;'>
                $value
              </div>
            </div></div>";
        }
