...
<head>
    ...
    <title>Amanda Conley Photography Portfolio</title>
...
<?php require $_SERVER['DOCUMENT_ROOT'].'/modules/nav.php'; ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Portfolio
                    <small>Amanda Conley Photography</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a></li>
                    <li><a href="portfolio.php">Personal Works Portfolio</a></li>
                    <li class="active">Amanda Conley Photography</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <h3>Project Description <br>(Coming Soon)</h3>
