...
<?php require $_SERVER['DOCUMENT_ROOT'].'/modules/nav.php'; ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <h3><b>The Pit Crew Automotive</b></h3>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <p>This site was developed for a class at BYU-I and features organization login management, multi-user management, and event management (based on location and date).  Users can open this app on their mobile devices and sign in to an event.  Once the event is selected a tally counter is displayed on the screen with several counting options.  User totals are synced via AJAX to a MySQL database automatically.  Every 5 seconds the app pulls the most recent total count from all of the devices and displays it on each device.</p>
                <ul>
                    <li>Currently Live</li>
                    <li>Database Integration</li>
                    <li>Built from the ground up without a framework</li>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <a href="portfolio-sabuWorks.php">
                    <img class="img-responsive img-hover" src="/images/portfolio/sabuWorks/homePage.png" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3><b>Sabu Works</b></h3>
                <h4>HTML5, CSS3, JavaScript, PHP, MySQL</h4>
                <p>I created Sabu Works for a friend who wanted a way to rent his personal camera equipment in the local area.  This site features user account creation (for the general user) along with a full administrator control panel.  This site is FULLY database driven.  All content including menus can be edited and created from within the administration panel.  Panel displayed after login is determined based upon users security level.</p>
                <ul>
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-amandaConley.php">
