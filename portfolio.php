    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="portfolio-pitCrew">Learn More</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="portfolio-tally">Learn More</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="portfolio-sabuWorks">Learn More</a>
            </div>
        </div>
        <!-- /.row -->
        <hr>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="portfolio-amandaConley">Learn More</a>
            </div>
        </div>
        <!-- /.row -->
